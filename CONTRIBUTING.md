...
Public documentation lives in Rustdoc comments under `openraft/src/docs/` and is published on [docs.rs](https://docs.rs/openraft/0.10.0-alpha.33/openraft/docs/index.html). Update it when a public API or user-facing behavior changes.
