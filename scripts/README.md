...
working-tree paths. Links to other hosts, links pinned to a commit or tag, and
Rustdoc intra-doc targets such as `crate::docs::getting_started` are left
alone. `make docs-check` runs it, and so does the CI lint job.
