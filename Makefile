...
typos:
	...
	typos --write-changes openraft/ tests/ stores/memstore/ stores/memstore-custom-node-id/ examples/log-wal/ examples/raft-kv-log-wal-sm-mem/ examples/raft-kv-memstore/ examples/raft-kv-rocksdb/
