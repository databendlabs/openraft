...
# The path sits on a 1000-unit em with its baseline at y = 0; the word advances
# WORD_ADVANCE units and its capitals rise WORD_CAP_HEIGHT units above the baseline.
WORD_ADVANCE = 4500
WORD_CAP_HEIGHT = 729
WORD_PATH = (
