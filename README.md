...
- 💡 **Example Applications**:
    ...
    - [Examples with OpenRaft 0.10](https://github.com/databendlabs/openraft/tree/release-0.10/examples) require OpenRaft `0.10.0-alpha.27` (alpha) on [crates.io/openraft](https://crates.io/crates/openraft);
...
- **Branch main** has been under active development.
    ...
    Latest alpha on crates.io: [v0.10.0-alpha.27](https://crates.io/crates/openraft/0.10.0-alpha.27).
