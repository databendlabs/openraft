...
- ✅ **Optional quorum-loss inactivity**: set `Config::quorum_loss_probe_interval` to pause ordinary Leader traffic when its quorum activity evidence expires and send scheduled recovery probes. Disabled by default; see [CheckQuorum][].
