...
- ✅ **Optional quorum-loss inactivity**: set `Config::quorum_loss_probe_interval` to alternate heartbeat suppression and recovery periods after quorum evidence expires. Disabled by default; see [CheckQuorum][].
