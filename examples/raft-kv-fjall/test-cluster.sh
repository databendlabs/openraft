...
bin=./target/debug/raft-key-value-fjall

echo "Killing all running raft-key-value-fjall and cleaning up old data"
...
echo "Start 3 uninitialized raft-key-value-fjall servers..."
