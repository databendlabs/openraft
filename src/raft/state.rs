...
pub(crate) enum RaftState<E: AppError, N: RaftNetwork<E>, S: RaftStorage<E>> {
...
impl<E: AppError, N: RaftNetwork<E>, S: RaftStorage<E>> fmt::Display for RaftState<E, N, S> {
...
pub(crate) struct LeaderState<E: AppError, N: RaftNetwork<E>, S: RaftStorage<E>> {
...
pub(crate) struct ReplicationState<E: AppError, N: RaftNetwork<E>, S: RaftStorage<E>> {
    pub match_index: u64,
