    ...
    N: Node,
{
    ...
    /// - `proposed` is a valid membership on its own. A public constructor is not enough of a
    ///   guarantee: deserialization, [`Membership::default()`] and
    ///   [`Membership::new_with_defaults()`] can all produce an invalid value.
