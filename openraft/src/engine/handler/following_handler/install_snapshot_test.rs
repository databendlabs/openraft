    ...
    assert_eq!(
        vec![
            ...
            Command::from(sm::Command::install_full_snapshot(
                ...
                IOId::new_append_log(Vote::new(2, 1).into_committed(), Some(log_id(4, 1, 6))),
            )),
    ...
    assert_eq!(
        vec![
            ...
            Command::from(sm::Command::install_full_snapshot(
                ...
                IOId::new_append_log(Vote::new(2, 1).into_committed(), Some(log_id(5, 1, 6)))
            )),
    ...
    assert_eq!(
        vec![
            Command::from(sm::Command::install_full_snapshot(
                ...
                IOId::new_append_log(Vote::new(2, 1).into_committed(), Some(log_id(100, 1, 100)))
            )),
            Command::PurgeLog {
