...
> This guide is under construction; it currently covers the `snapshot_id` and
> optional quorum-loss inactivity changes.
...
the interval has a nominal liveness floor of at least
