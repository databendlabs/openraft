...
- [`protocol`](crate::docs::protocol) :
  - [`check_quorum`](`crate::docs::protocol::check_quorum`) explains how a leader stops accepting new proposals when its quorum lease expires, and how to optionally retire it after continued quorum loss;
