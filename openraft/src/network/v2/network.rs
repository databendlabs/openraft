...
/// and introduces the `full_snapshot()` method that lets the application fully customize snapshot transmit.
///
...
where C: RaftTypeConfig
{
    ...
    /// follower.
    /// When the follower finished receiving the snapshot, it calls [`Raft::install_full_snapshot()`]
    /// with this vote.
    ///
