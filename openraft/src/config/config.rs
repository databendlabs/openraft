...
pub struct Config {
    ...
    /// The maximum number of log entries to batch in a single storage I/O operation.
    ///
    ...
    pub max_in_batch_entries: Option<u64>,
...
impl Config {
    ...
    /// Get the maximum number of log entries to batch in a single storage I/O operation.
    ///
    /// Defaults to 4096 if not specified.
    pub(crate) fn max_in_batch_entries(&self) -> u64 {
        self.max_in_batch_entries.unwrap_or(4096)
    }
