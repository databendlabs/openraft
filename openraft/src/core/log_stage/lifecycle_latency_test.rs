...
fn test_display_cumulative_duration_follows_stage_order() {
    ...
    latency.appended(1, instant_at(base, 10));
    ...
    assert!(s.contains("appended +0.00ns (1.00ms)"));
...
fn test_display_duration_uses_at_most_two_fraction_digits() {
    ...
    latency.appended(1, base + Duration::from_nanos(1_223_584));
