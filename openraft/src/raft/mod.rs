...
/// The actual work is performed by [`RaftCore`], which runs as a separate task processing
...
///    - Client operations: [`client_write`](Raft::client_write), [`ensure_linearizable`](Raft::ensure_linearizable)
...
/// to hold handles to the same Raft node. All clones reference the same underlying `RaftCore`.
///
/// # Error Handling
///
...
/// - [`RaftCore`] for the internal state machine implementation
