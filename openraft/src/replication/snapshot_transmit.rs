...
use crate::replication::snapshot_transmit_handle::SnapshotTransmitterHandle;
...
{
    pub(crate) task_state: ReplicationContext<C>,
...
{
    pub(crate) fn spawn(
        replication_task_state: ReplicationContext<C>,
        network: N::Network,
        snapshot_reader: SnapshotReader<C>,
        replication_id: InflightId,
