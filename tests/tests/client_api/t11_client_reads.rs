...
async fn ensure_linearizable_different_policies() -> Result<()> {
    ...
    tracing::info!("--- testing LeaseRead policy");
    {
        ...
        router
            .ensure_linearizable(leader, ReadOnlyPolicy::LeaseRead)
            .await
        ...
        router.set_network_error(1, true);
        router.ensure_linearizable(leader, ReadOnlyPolicy::LeaseRead).await?;
    ...
    tracing::info!("--- testing followers with different policies");
    {
        ...
        router
            .ensure_linearizable(1, ReadOnlyPolicy::LeaseRead)
            .await
